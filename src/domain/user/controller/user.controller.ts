...
export interface IUserController {
  ...
  getAll(req: Request, res: Response): Promise<Response<PaginationResponse<UserResponseDTO> | ErrorResponse>>;
...
export class UserController implements IUserController {
  ...
  public async getAll(req: Request, res: Response): Promise<Response<PaginationResponse<UserResponseDTO> | ErrorResponse>> {
    try {
